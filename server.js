...
const getPriceHistory = async () => {
    ...
    const coinIdsArray = await getCoindIds().then(coinIdsReturnArray => console.log("Promise returned, no?" + coinIdsReturnArray)); // it's returning a "Promise { [] }"", try to figure out the fix to get this bit done
    console.log("Logging coindIdsArray from getPriceHistory function:" + coinIdsArray);
    //console.log(coinIds);
    for(id in coinIds) {
